@extends('layouts.master', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => env('APP_NAME')])
                            ...
                            <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                           placeholder="{{ __('Name...') }}" value="{{ old('name') }}" autocomplete="name" required autofocus>
                                </div>
                                @if ($errors->has('name'))
